...
parser.add_option("--optimized_poses1", dest="optimized_poses1",
                  default="/home/sun/slambook2/ch10/result/txt/after_GN.txt", help="The filename that contains the optimized poses.")
parser.add_option("--optimized_poses2", dest="optimized_poses2",
                  default="/home/sun/slambook2/ch10/result/txt/after_LM.txt", help="The filename that contains the optimized poses.")
parser.add_option("--optimized_poses3", dest="optimized_poses3",
                  default="/home/sun/slambook2/ch10/result/txt/after_DL.txt", help="The filename that contains the optimized poses.")
...
if poses_optimized1 is not None:
    plot.plot(poses_optimized1[:, 0], poses_optimized1[:, 1], '-', label="GN",
              alpha=0.5, color="red")
if poses_optimized2 is not None:
    plot.plot(poses_optimized2[:, 0], poses_optimized2[:, 1], '-', label="LM",
              alpha=0.5, color="blue")
if poses_optimized3 is not None:
    plot.plot(poses_optimized3[:, 0], poses_optimized3[:, 1], '-', label="DogLeg",
